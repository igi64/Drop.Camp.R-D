...
#define MY_WARN(msg) fprintf(stdout, "\033[01;33m native:%s \033[00m\n", msg)
#define MY_ERROR(msg) fprintf(stdout, "\033[01;32m native:%s \033[00m\n", msg)
#define MY_INFO(msg) fprintf(stdout, "\033[01;34m native:%s \033[00m\n", msg)
